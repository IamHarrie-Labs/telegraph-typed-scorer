...
pub unsafe extern "C" fn rank_answer(
    ...
    // A verbatim answer is a perfect answer. The embedding composite does not
    // guarantee this — on the benchmark below it scores some exact matches as
    // low as 0.57, which is under the 0.75 `worst_self_match` bar the node
    // requires of a candidate module. Short-circuiting removes that risk.
